...
SET(OpenCV_INCLUDE_DIRS "C:/git/opencv/build64" "C:/git/opencv/opencv/include" "C:/git/opencv/opencv/include/opencv")
...
SET(OpenCV_LIB_DIR C:/git/opencv/build64/lib)
...
# ==============================================================
if(NOT "C:/git/opencv/opencv" STREQUAL  "")
    foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
        # We only need the "core",... part here: "opencv_core" -> "core"
        STRING(REGEX REPLACE "opencv_(.*)" "\\1" __MODNAME ${__CVLIB})
        INCLUDE_DIRECTORIES("C:/git/opencv/opencv/modules/${__MODNAME}/include")
    endforeach()
endif()
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("C:/git/opencv/build64/3rdparty/lib")
